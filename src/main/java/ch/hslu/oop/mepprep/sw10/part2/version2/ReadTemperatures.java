...
public class ReadTemperatures {
    ...
    public static void main(String[] args) {
        ...
        temperatures.addTemperaturEventListener(ReadTemperatures::handleTemperatureEvent);
    ...
    private static void handleTemperatureEvent(TemperaturEvent event) {
        System.out.println("New " + event.getState().getStringValue() + " Value: " + event.getNewValue());
    }
