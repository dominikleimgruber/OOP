...
class TemperaturTest {
    ...
    @Test
    void testCelsiusToKelvinIllegalValue(){
        final IllegalArgumentException e =
                assertThrows(IllegalArgumentException.class, () -> Temperatur.celsiusToKelvin(-300));
        assertEquals("Value below 0 Kelvin or not a number.", e.getMessage());
    }


    @Test
    void testKelvinToCelsiusIllegalValue(){
        final IllegalArgumentException e =
                assertThrows(IllegalArgumentException.class, () -> Temperatur.kelvinToCelsius(-0.001f));
        assertEquals("Value below 0 Kelvin or not a number.", e.getMessage());
    }
